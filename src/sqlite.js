...
async function loadInitData(db) {
  ...
  await db.run(
    `INSERT INTO Challenges (title, reward, description, complete) VALUES
           ...
           ('Geoguessr', 'Ride the bus 15 minutes.', 'Find and place yourself in one of <a href="https://reecen.link/fzk6ba" target="_blank">these photos</a>! You may not use google maps or street view to assist your search.', 0),
